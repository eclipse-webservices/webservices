...
public class JAXWSCoreMessages extends NLS {
    ...
    public static String WEBSERVICE_ENPOINTINTERFACE_NOT_FOUND_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NOT_ANNOTATED_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NOT_PUBLIC_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_WEBMETHODS_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NOT_OUTER_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_NAME_ATTRIBUTE_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_SOAPBINDING_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_WEBRESULT_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_WEBPARAM_ERROR_MESSAGE;
    public static String WEBSERVICE_ENPOINTINTERFACE_NO_ONEWAY_ERROR_MESSAGE;
    ...
    public static String OPERATION_NAMES_MUST_BE_UNIQUE_ERROR_MESSAGE;
    public static String WRAPPER_BEAN_NAMES_MUST_BE_UNIQUE_ERROR_MESSAGE;
    public static String FAULT_BEAN_NAMES_MUST_BE_UNIQUE_ERROR_MESSAGE;
    public static String DOC_BARE_METHODS_UNIQUE_XML_ELEMENTS_ERROR_MESSAGE;
