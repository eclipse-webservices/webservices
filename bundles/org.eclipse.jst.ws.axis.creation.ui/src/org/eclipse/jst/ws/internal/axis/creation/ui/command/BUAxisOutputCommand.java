...
public class BUAxisOutputCommand extends SimpleCommand {
	...
	private JavaWSDLParameter javaWSDLParameter_;
	  ...
	  private MessageUtils msgUtils_;
		...
		*/
		...
		public Status execute(Environment env){
			...
			ws_.getAxisWebServiceInfo().setJavaWSDLParameter(javaWSDLParameter_);
		...
		public void setJavaWSDLParameter_(JavaWSDLParameter javaWSDLParameter_) {
			this.javaWSDLParameter_ = javaWSDLParameter_;
		}
